...
# İki dökümanda geçen tüm kelimelerden bir küme yapacağız. 
# Sonra bu kümedeki kelimeler tek tek dökümanlarda ayrı ayrı kontrol edilecek.
# Kelime dökümanda var mı, var ise kaç tane? sorgusu yapılacak.
...
# Her iki döküman için vektör oluşturuluyor.
# Dökümanda geçen kelimelerin frekansından liste oluşturuluyor. 
# Eğer kelime yok ise sıfır yazılıyor.
vector1 = []
vector2 = []
